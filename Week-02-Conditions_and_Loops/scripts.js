...
// //we need a variable to assign to a score
// //based on the #score, we have to assign a grade
...
//check to see if number is between 1 and 100
// if(number >= 1 && number <= 100) {
//   //check to see if a number is even
//   while(number % 2 === 0) {
//     console.log(`Number ${number} is between 1 and 100 and number is also even`);
//     number++;
//   } 
...
//if / else statement
//check to see if number is between 1 and 100
//while a number is between 1 and 100, print that number and all numbers to 100

// let x = 10;

// if(x >= 1 && x <= 100) { //checking to see if x is between 1 and 100
//   while(x >= 1 && x <= 100){ // while x is between
...
// console.log(`My cat is named ${cat}. She is a trouble maker`)
// console.log(`
// My dog is named ${dog}. 
// She is part doxen. She's 8 years old
